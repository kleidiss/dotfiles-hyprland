...
cp "${HOME}"/dotfiles/.cache/wal/pywal.kvconfig "${HOME}"/dotfiles/.config/Kvantum/pywal/pywal.kvconfig
cp "${HOME}"/dotfiles/.cache/wal/pywal.svg "${HOME}"/.config/Kvantum/pywal/pywal.svg
